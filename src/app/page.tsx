...
// Import your custom Image component (ensure this exists in the correct directory)
import Image from "next/image"; // Make sure this is the correct path
...
export default function About() {
  ...
  understanding Pizzateria
          ...
          {/* Image component with fixed properties */}
