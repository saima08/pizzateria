          ...
          <div className="space-y-8 animate-slide-in-left">
            <blockquote className="relative">
              ...
              <p className="relative text-xl md:text-2xl font-medium text-white pl-10">
                &ldquo;Pizzateria is exceptional. With a wide array of delicious meals and excellent service, including remarkably fast delivery, I wholeheartedly recommend Pizzateria to you.&rdquo;
              </p>
            </blockquote>
