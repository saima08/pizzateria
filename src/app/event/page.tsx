                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                {event.images.map((image, imgIndex) => (
                                    ...
                                    >
                                        ...
                                        <button
                                            className="absolute bottom-4 right-4 px-4 py-2 bg-white text-black rounded-full flex items-center gap-2 text-sm"
                                            onClick={() => {
                                                // Placeholder action, can be replaced with a modal or navigation
                                                alert(`Read more about ${event.title}`);
                                            }}
                                        >
                                            Read more
